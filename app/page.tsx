      ...
      <section className="relative -mt-16 flex min-h-screen items-center">
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1280px] px-6 py-24">
          <div className="max-w-2xl">
            ...
            <h1 className="mb-6 font-display text-5xl font-extrabold leading-tight tracking-tight text-white lg:text-6xl">
              Industrial Chemistry,{" "}
              <span className="text-accent">Engineered</span> for Impact
            </h1>
